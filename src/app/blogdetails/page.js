            ...
            <div className="grid grid-cols-2 gap-10">
              <div
                className={`border  hover:bg-gradient-to-r from-[#e82e5d] via-purple-500 to-[#0176bc] ${
                  activeSection2 === "Best Professional Thesis Writers"
                    ? "bg-gradient-to-r from-[#e82e5d] via-purple-500 to-[#0176bc] text-white"
                    : "text-gray-900 bg-gray-100"
                } `}
                onClick={() =>
                  handleSectionClick2("Best Professional Thesis Writers")
                }
              >
                <p className="p-5  hover:bg-gradient-to-r from-[#e82e5d] via-purple-500 to-[#0176bc] cursor-pointer  pvtleft  flex items-center">
                  <span className="px-2">Best Professional Thesis Writers</span>
                </p>
              </div>
              {/* blog footer */}
              <div
                className={`border  ${
                  activeSection2 === "Client Satisfaction"
                    ? "bg-gradient-to-r from-[#e82e5d] via-purple-500 to-[#0176bc] text-white"
                    : "text-gray-900 bg-gray-100"
                } `}
                onClick={() => handleSectionClick2("Client Satisfaction")}
              >
                <p className="p-5 hover:bg-gradient-to-r from-[#e82e5d] via-purple-500 to-[#0176bc] cursor-pointer  pvtleft flex items-center">
                  <span className="px-2">Client Satisfaction</span>
                </p>
              </div>
            </div>
            <div>
                ...
                {activeSection2 === "Best Professional Thesis Writers" && (
                  <div className="h-full text-justify">
                    <p>
                      Our premium services ensure complete confidence in your
                      thesis. It’s crucial to remember that the race to launch a
                      successful career begins now, and a well-written PhD
                      thesis can propel you forward. We can provide support with
                      every aspect of your thesis, from choosing a topic to
                      crafting a comprehensive summary and completing the entire
                      thesis or specific chapters. In essence, we’re here to
                      guide you through your entire PhD research journey,
                      offering expertise from start to finish.
                    </p>
                    <p>
                      Our team of ‘Expert Content Writers’ boasts high
                      qualifications and specializes in various fields. Their
                      meticulous guidance will address your concerns and
                      questions at every stage of thesis preparation.
                      Furthermore, they can offer valuable suggestions to
                      enhance and refine your Ph.D. Thesis.
                    </p>
                  </div>
                )}
                {/* show data */}
                  ...
                  <div className="h-full">
                    <div className="text-justify">
                      <p>
                        ...
                        determine the desired formatting for your thesis,
                        customizing our top-notch thesis writing and editing
                        services to meet your exact specifications. Each and
                        every customer holds significant value for us,
                        regardless of whether they engage in a single
                        transaction or multiple interactions. Our custom thesis
                        writing service is staffed by proficient thesis paper
                        and dissertation writers who possess expertise across
                        various academic domains, capable of navigating the
                        intricacies of academic writing. If you’re seeking
                        affordable “Thesis Writing Services,” Research
                        Developers is your ideal destination to effectively
                        address and overcome these challenges. We pride
                        ourselves on delivering the best theses that precisely
                        reflect your academic knowledge and understanding.
                      </p>
                    </div>
                  </div>
                )}
