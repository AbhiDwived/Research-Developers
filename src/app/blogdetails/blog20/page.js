          ...
          <div className="lg:w-full col-span-2">
            ...
            <div className="col-span-2 bg-white p-10 mt-10">
              ...
              <p className="pt-2 text-justify">
                ...
                tailor our services to suit their specific needs. Whether you're
                in the early stages of research, seeking assistance in choosing
                a suitable topic, or require comprehensive support in compiling
                and presenting literature sources in the form of a
