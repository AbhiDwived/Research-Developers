...
const AccordionFaq = ({ title, children, isOpen, onClick }) => {
  return (
    <div className="border my-5 border-gray-300 rounded-md" data-aos="fade-up">
      <div
        className={`flex justify-between items-center px-4 py-5 rounded  hover:text-white hover:bg-gradient-to-r from-[#0176bc] via-purple-500 to-[#e82e5d] cursor-pointer ${isOpen
...
console.log(dataPath.content[0].para)
